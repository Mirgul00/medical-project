...
function openServiceModal(card) {
  if (!serviceModal || !modalTitle || !modalDesc || !modalPrice || !card) return
...
function renderResultCase() {
  ...
  if (resultsBefore) resultsBefore.src = item.before_image
  if (resultsAfter) resultsAfter.src = item.after_image
